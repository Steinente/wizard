...
export const SCOREBOARD_A11Y_ROUND_SCOPE_KEY = 'wizard.scoreboardA11yRoundScope'
export const CHAT_SOUND_ENABLED_KEY = 'wizard.chatSoundEnabled'
export const CARD_ARTWORK_ENABLED_KEY = 'wizard.cardArtworkEnabled'
export const HAND_SORT_ENABLED_KEY = 'wizard.handSortEnabled'
export const CARD_PLAY_ANIMATION_ENABLED_KEY = 'wizard.cardPlayAnimationEnabled'
export const APP_FONT_KEY = 'wizard.appFont'
