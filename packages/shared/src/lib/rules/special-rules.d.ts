...
export declare const SPECIAL_CARD_DEFINITIONS: Record<SpecialCard['special'], SpecialCardDefinition>;
export declare const getSpecialCardDefinition: (card: Card) => SpecialCardDefinition | null;
