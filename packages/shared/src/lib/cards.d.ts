...
export declare const CARD_TYPES: readonly ["number", "wizard", "jester", "special"];
export type CardType = (typeof CARD_TYPES)[number];
export declare const SPECIAL_CARD_KEYS: readonly ["shapeShifter", "bomb", "werewolf", "cloud", "juggler", "dragon", "fairy"];
